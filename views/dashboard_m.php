    ...
    <header>
        ...
        <aside class="absolute top-0 left-0 h-screen w-44 bg-green-400 p-6 z-10">
            <button onclick="window.location.href='login.php'"
                class="w-full bg-white text-green-600 font-medium mt-2 px-4 py-2 rounded-lg shadow hover:bg-green-50 transition-colors duration-200">
